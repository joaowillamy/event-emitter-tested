...
describe('listening and unlistening', () => {
  it('.on() - should register a event listener', () => {
  ...
  it('.on() - should register more than one event listener', () => {
    const emitter = EventEmitter.create()
  ...
  it('.on() - should NOT register the same listener more than once', () => {
    const emitter = EventEmitter.create()
    const [callback1, callback2] = [jest.fn(), jest.fn()]
  ...
  it('.on() - should throw an error if no callback is passed', () => {
    const emitter = EventEmitter.create()
  ...
  it('.off() - should unregister a specific event listener', () => {
    const emitter = EventEmitter.create()
    const [callback1, callback2] = [jest.fn(), jest.fn()]
  ...
  it(".off() - should not throw if event doesn't exist", () => {
    const emitter = EventEmitter.create()

    expect(() => emitter.off('some-event')).not.toThrow()
  })

  it('.on() - should return a method which unregisters the passed listener', () => {
    const emitter = EventEmitter.create()
    const [callback1, callback2] = [jest.fn(), jest.fn()]
    ...
    expect(emitter.events.load).toContain(callback2)
  })
})

describe('emitting events', () => {
  it('.emit() - should emit an event and execute all listeners callbacks', () => {
    const emitter = EventEmitter.create()
    const [callback1, callback2] = [jest.fn(), jest.fn()]
  ...
  it('.emit() - should pass event data, as the second argument, to all callbacks', () => {
    const emitter = EventEmitter.create()
    const callback = jest.fn()
  ...
  it('.emit() - should pass event `type` to all callbacks', () => {
    const emitter = EventEmitter.create()
    const callback = jest.fn()
  ...
  it.skip('.emit() - should do nothing if event has no callbacks', () => {
    const emitter = EventEmitter.create()
...
describe('special listeners', () => {
  describe('once()', () => {
    it.skip('should listen to an event only once', () => {
      const emitter = EventEmitter.create()
    ...
    it.skip('should return a method to cancel the listener', () => {
      const emitter = EventEmitter.create()
    ...
    it.skip('listener should received the event data', () => {
      const emitter = EventEmitter.create()
    ...
    it.skip('should guarantee every callback is executed and only .once() are removed', () => {
      const emitter = EventEmitter.create()
  ...
  describe('race()', () => {
    it.skip('should accept an array of [event, callback], execute listeners of first emitted event and unlisten all of them', () => {
      const emitter = EventEmitter.create()
    ...
    it.skip('should return a method which cancels all listeners', () => {
      const emitter = EventEmitter.create()
    ...
    it.skip('should guarantee every callback is executed and only .race() callbacks are removed', () => {
      const emitter = EventEmitter.create()
